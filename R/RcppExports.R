...
lapOfG <- function(sub, f1hz, f2hz, cent_f1hz, cent_f2hz, sf, npix) {
    .Call(`_jres_lapOfG`, sub, f1hz, f2hz, cent_f1hz, cent_f2hz, sf, npix)
}
...
pickPeaks_rcpp <- function(jr, f1hz, f2ppm, noise, boundary, sf) {
    .Call(`_jres_pickPeaks_rcpp`, jr, f1hz, f2ppm, noise, boundary, sf)
}
